...
SQL_ADD_SONG = """ INSERT INTO songs (song_name, artist_name, album_name, is_private, added_to_sd)
                   VALUES(?,?,?,?,?) """

SQL_ADD_ALBUM = """ INSERT INTO albums (album_name, artist_name, is_private, added_to_sd)
                    VALUES(?,?,?,?) """
